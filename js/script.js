  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <div class="container-fluid">
          <div class="footer">
            <div class="sort-note">
              <a class="navbar-brand" href="index.html">Muiz A</a>
              <p>I’m Muiz Asif, a talented Web front end developer.</p>
              <hr style="margin: 20px 0; color: rgb(82, 82, 82); width: 60%;">
              <span class="contact"><a href="mailto:muizasif29@gmail.com" class="email">
                <img src="./img/email.png" alt="email me"> &nbsp; &nbsp;
                muizasif29@gmail.com</a></span>
            </div>
            ...
            <div class="social-links text-center">
              <a href="#"><img src="./img/LinkedIn Circled.png" alt="linkedin"></a><br>
